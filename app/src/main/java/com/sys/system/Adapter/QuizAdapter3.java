...
import com.sys.system.Activity.Easy_edit;
import com.sys.system.R;

import java.util.List;

public class QuizAdapter3 extends RecyclerView.Adapter<QuizAdapter3.QuizViewHolder> {
    private Context context;
    private List<DataSnapshot> quizDataSnapshots;

    public QuizAdapter3(Context context, List<DataSnapshot> quizDataSnapshots) {
                        ...
                        builder.setItems(new CharSequence[]{"Update", "Delete"}, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int which) {
                                if (which == 0) {
                                    ...
                                    Intent intent = new Intent(context, Easy_edit.class);
                                    ...
                                    DatabaseReference questionsRef = database.child("Python_quiz").child(questionId);
