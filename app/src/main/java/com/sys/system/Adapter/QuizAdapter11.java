...
import com.sys.system.Activity.Update_set_b;
import com.sys.system.R;

import java.util.List;

public class QuizAdapter11 extends RecyclerView.Adapter<QuizAdapter11.QuizViewHolder> {
    private Context context;
    private List<DataSnapshot> quizDataSnapshots;

    public QuizAdapter11(Context context, List<DataSnapshot> quizDataSnapshots) {
                        ...
                        builder.setItems(new CharSequence[]{"Update", "Delete"}, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int which) {
                                if (which == 0) {
                                    ...
                                    Intent intent = new Intent(context, Update_set_b.class);
