...
public class FilesAdapter10 extends RecyclerView.Adapter<FilesAdapter10.ViewHolder> {

    private List<FileModel> fileList;
    private Context context;
    private List<FileModel> filteredList;

    public FilesAdapter10(Context context, List<FileModel> fileList) {
    ...
    private void reuploadFile(FileModel fileModel, ProgressDialog progressDialog) {
        DatabaseReference archiveReference = FirebaseDatabase.getInstance().getReference("Archive_modules2");
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if (archivedFile != null) {
                        ...
                        DatabaseReference sourceReference = FirebaseDatabase.getInstance().getReference("Python").child(archivedFile.getId());
    ...
    private void showDeleteConfirmationDialog(FileModel fileModel) {
        ...
        builder.setPositiveButton("Delete", (dialog, which) -> {
            ...
            new Handler().postDelayed(() -> {
                ...
                DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("Archive_modules2");
