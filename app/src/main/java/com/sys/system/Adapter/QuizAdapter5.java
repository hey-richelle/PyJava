...
public class QuizAdapter5 extends RecyclerView.Adapter<QuizAdapter5.QuizViewHolder> {
    private Context context;
    private List<DataSnapshot> quizDataSnapshots;

    public QuizAdapter5(Context context, List<DataSnapshot> quizDataSnapshots) {
