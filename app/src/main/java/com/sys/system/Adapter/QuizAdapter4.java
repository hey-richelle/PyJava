...
import com.sys.system.Activity.Edit_java;
import com.sys.system.R;

import java.util.List;

public class QuizAdapter4 extends RecyclerView.Adapter<QuizAdapter4.QuizViewHolder> {
    private Context context;
    private List<DataSnapshot> quizDataSnapshots;

    public QuizAdapter4(Context context, List<DataSnapshot> quizDataSnapshots) {
                        ...
                        builder.setItems(new CharSequence[]{"Update", "Delete"}, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int which) {
                                if (which == 0) {
                                    ...
                                    Intent intent = new Intent(context, Edit_java.class);
                                    ...
                                    DatabaseReference questionsRef = database.child("Java_Easy").child(questionId);
