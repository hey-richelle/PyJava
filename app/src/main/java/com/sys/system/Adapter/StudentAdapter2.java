...
import com.sys.system.Class.Student;
...
public class StudentAdapter2 extends ArrayAdapter<Student> implements Filterable {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        viewHolder.easyScoreTextView.setText("Python Easy Score: " + student.getEasyScore());
        viewHolder.normalScoreTextView.setText("Python Normal Score: " + student.getNormalScore());
        viewHolder.hardScoreTextView.setText("Python Hard Score: " + student.getHardScore());// Set the picture score
