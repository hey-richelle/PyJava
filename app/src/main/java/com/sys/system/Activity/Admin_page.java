...
// Start the animation
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        if (parent.getItemAtPosition(position).equals("Java")) {
            ...
            Intent intent = new Intent(getApplicationContext(), com.sys.system.Activity.java.class);
            startActivity(intent);
            overridePendingTransition(0, 0); // Disable animation
            finish();
            ...
            Intent intent = new Intent(getApplicationContext(), com.sys.system.Activity.python.class);
            startActivity(intent);
            overridePendingTransition(0, 0); // Disable animation
            finish();
