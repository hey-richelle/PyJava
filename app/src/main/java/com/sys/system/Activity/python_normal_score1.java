...
public class python_normal_score1 extends AppCompatActivity {
    Button exit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (actionBar != null) {
            ...
            setContentView(R.layout.activity_python_normal_score1);
            ...
            exit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Toast.makeText(python_normal_score1.this, "Back to QUIZ", Toast.LENGTH_SHORT).show();
    ...
    public void onBackPressed() {
        Intent intent = new Intent(python_normal_score1.this, easy3.class);
        startActivity(intent);
        overridePendingTransition(0,0);
        super.onBackPressed();
    }
