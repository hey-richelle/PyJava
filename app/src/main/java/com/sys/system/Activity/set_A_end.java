...
public class set_A_end extends AppCompatActivity {
    Button exit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (actionBar != null) {
            ...
            setContentView(R.layout.activity_set_aend);
            ...
            exit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Toast.makeText(set_A_end.this, "Back to QUIZ", Toast.LENGTH_SHORT).show();
    ...
    public void onBackPressed() {
        Intent intent = new Intent(set_A_end.this, easy2.class);
        startActivity(intent);
        overridePendingTransition(0,0);
        super.onBackPressed();
    }
