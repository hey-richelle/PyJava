...
public class python_hard_mode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python_hard_mode);
        ...
        if (actionBar != null) {
            ...
            exit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Toast.makeText(python_hard_mode.this, "Back to QUIZ", Toast.LENGTH_SHORT).show();
            ...
            if (currentUser != null) {
                ...
                databaseRef.child("Python_hard_score").child(userId).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists()) {
                            ...
                            databaseRef.child("Python_hard").child(userId).addListenerForSingleValueEvent(new ValueEventListener() {
                                @Override
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    if (dataSnapshot.exists()) {
    ...
    public void onBackPressed() {
        Intent intent = new Intent(python_hard_mode.this, java_python.class);
        startActivity(intent);
        super.onBackPressed();
    }
}
