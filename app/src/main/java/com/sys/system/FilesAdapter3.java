...
public class FilesAdapter3 extends RecyclerView.Adapter<FilesAdapter3.ViewHolder> {

    private List<FileModel> fileList;
    private Context context;
    private List<FileModel> filteredList;

    public FilesAdapter3(Context context, List<FileModel> fileList) {
    ...
    private void archiveFile(FileModel fileModel, ProgressDialog progressDialog) {
        DatabaseReference sourceReference = FirebaseDatabase.getInstance().getReference("Python").child(fileModel.getId());
        ...
        sourceReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (archivedFile != null) {
                    ...
                    DatabaseReference archiveReference = FirebaseDatabase.getInstance().getReference("Archive_modules2").push();
