...
public class picture_end extends AppCompatActivity {
    Button exit;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_picture_end);
        ...
        if (actionBar != null) {
            ...
            exit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Toast.makeText(picture_end.this, "Back to QUIZ", Toast.LENGTH_SHORT).show();
